...
namespace CosmosdbSqlApiQuickstart
{
    class Program
    {
        ...
        private static readonly string EndpointUri = "https://sridharcosmosdbsql.documents.azure.com:443/";
        // The primary key for the Azure Cosmos account.
        private static readonly string PrimaryKey = "wSEITdQey5PrL7KcBeEV1z8MGcy13DXIuRC3G1dinFBLRELlvK02qf0DCuXl3dK8r9a9v2LVo9E1eK3RCEvIww==";
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine("Begin Cosmosdb SQL Api Quickstart...\n");
